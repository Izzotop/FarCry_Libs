    ...
    void operator()(std::vector<string>& instr) {
        ...
        if (op == "add" || op == "sub") {
            ...
            if (mask == GL_RGBA || mask == GL_RGB) {
                ...
                glCombinerOutputNV(C, GL_RGB, GL_DISCARD_NV, GL_DISCARD_NV, dreg, scale, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            } else {
                glCombinerOutputNV(C, GL_RGB, GL_DISCARD_NV, GL_DISCARD_NV, GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            }
            ...
            if (mask == GL_RGBA || mask == GL_ALPHA) {
                ...
                glCombinerOutputNV(C, GL_ALPHA, GL_DISCARD_NV, GL_DISCARD_NV, dreg, scale, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            } else {
                glCombinerOutputNV(C, GL_ALPHA, GL_DISCARD_NV, GL_DISCARD_NV, GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            }
        } else if (op == "cnd") {
            src a(instr[3]);
            src b(instr[4]);
            ...
            if (mask == GL_RGBA || mask == GL_RGB) {
                ...
                glCombinerInputNV(C, GL_RGB, GL_VARIABLE_C_NV, b.reg, b.map, b.comp);
                glCombinerInputNV(C, GL_RGB, GL_VARIABLE_D_NV, GL_ZERO, GL_UNSIGNED_INVERT_NV, GL_RGB);
                glCombinerOutputNV(C, GL_RGB, GL_DISCARD_NV, GL_DISCARD_NV, dreg, scale, GL_NONE, GL_FALSE, GL_FALSE, GL_TRUE);
            } else {
                glCombinerOutputNV(C, GL_RGB, GL_DISCARD_NV, GL_DISCARD_NV, GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            }
            ...
            if (mask == GL_RGBA || mask == GL_ALPHA) {
                ...
                glCombinerInputNV(C, GL_ALPHA, GL_VARIABLE_C_NV, b.reg, b.map, GL_ALPHA);
                glCombinerInputNV(C, GL_ALPHA, GL_VARIABLE_D_NV, GL_ZERO, GL_UNSIGNED_INVERT_NV, GL_ALPHA);
                glCombinerOutputNV(C, GL_ALPHA, GL_DISCARD_NV, GL_DISCARD_NV, dreg, scale, GL_NONE, GL_FALSE, GL_FALSE, GL_TRUE);
            } else {
                glCombinerOutputNV(C, GL_ALPHA, GL_DISCARD_NV, GL_DISCARD_NV, GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            }
        } else if (op == "dp3") {
            ...
            if (mask == GL_RGBA || mask == GL_RGB) {
                ...
                glCombinerOutputNV(C, GL_RGB, dreg, GL_DISCARD_NV, GL_DISCARD_NV, scale, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            } else {
                // ooh.. what to do here?
            }
            ...
            if (mask == GL_RGBA || mask == GL_ALPHA) {
                glCombinerInputNV(C, GL_ALPHA, GL_VARIABLE_A_NV, a.reg, a.map, GL_ALPHA);
                glCombinerInputNV(C, GL_ALPHA, GL_VARIABLE_B_NV, GL_ZERO, GL_UNSIGNED_INVERT_NV, GL_ALPHA);
                glCombinerOutputNV(C, GL_ALPHA, dreg, GL_DISCARD_NV, GL_DISCARD_NV, scale, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            } else {
                glCombinerOutputNV(C, GL_ALPHA, GL_DISCARD_NV, GL_DISCARD_NV, GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE, GL_FALSE);
            }
        } else if (op == "mul") {
...
void ps10::invoke(std::vector<constdef>* c, std::list<std::vector<string>>* a, std::list<std::vector<string>>* b) {
