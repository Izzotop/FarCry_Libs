...
static const char yytranslate[] = {0,  2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
                                   10, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
...
#if YYDEBUG != 0
static const short yyprhs[] = {0, 0, 6, 11, 16, 20, 22, 25, 37, 39, 42, 46, 52, 60, 62, 65, 71, 79};

static const short yyrhs[] = {3,  4,  12, 14, 16, 0, 3, 4,  14, 16, 0,  3, 4, 12, 16, 0,  3, 4, 16, 0, 13, 0,  12, 13, 0,  7,  6,  10, 5, 10,
                              5,  10, 5,  10, 5,  4, 0, 15, 0,  14, 15, 0, 8, 6,  4,  0,  8, 6, 10, 6, 4,  0,  8,  6,  10, 6,  10, 6,  4, 0,
                              17, 0,  16, 17, 0,  9, 6, 10, 6,  4,  0,  9, 6, 10, 6,  10, 6, 4, 0,  9, 6,  10, 6,  10, 6,  10, 6,  4,  0};

#endif

#if YYDEBUG != 0
static const short yyrline[] = {0, 68, 75, 82, 89, 99, 107, 119, 133, 141, 152, 162, 174, 191, 199, 210, 223, 237};
#endif

#if YYDEBUG != 0 || defined(YYERROR_VERBOSE)

static const char* const yytname[] = {"$",   "error",          "$undefined.", "HEADER", "NEWLINE", "NUMBER", "REG",      "DEF",     "ADDROP", "BLENDOP",
                                      "','", "WholeEnchilada", "Defs",        "Def",    "AddrOps", "AddrOp", "BlendOps", "BlendOp", nullptr};
#endif

static const short yyr1[] = {0, 11, 11, 11, 11, 12, 12, 13, 14, 14, 15, 15, 15, 16, 16, 17, 17, 17};

static const short yyr2[] = {0, 5, 4, 4, 3, 1, 2, 11, 1, 2, 3, 5, 7, 1, 2, 5, 7, 9};

static const short yydefact[] = {0, 0, 0, 0, 0, 0,  0, 5,  0, 8, 4, 13, 0, 0,  0,  6, 0, 3, 9, 2,  14, 0, 10, 0, 0,
                                 1, 0, 0, 0, 0, 11, 0, 15, 0, 0, 0, 0,  0, 12, 16, 0, 0, 0, 0, 17, 0,  7, 0,  0, 0};

static const short yydefgoto[] = {47, 6, 7, 8, 9, 10, 11};

static const short yypact[] = {14, 17,     16, 20,     21,     22,     16, -32768, -4, -32768, 11,     -32768, 8,      2,      19, -32768, -4,
                               11, -32768, 11, -32768, 25,     -32768, 26, 27,     11, 24,     4,      9,      30,     -32768, 31, -32768, 32,
                               29, 36,     12, 37,     -32768, -32768, 35, 33,     40, 41,     -32768, 43,     -32768, 45,     48, -32768};

static const short yypgoto[] = {-32768, -32768, 44, 46, -6, -5, -10};

#define YYLAST 52

static const short yytable[] = {20, 17, 18, 19, 4, 5,  22, 20, 30, 20, 18, 25, 23, 32, 31, 20, 39, 1,  21, 33, 5,  2,  40, 3,  4, 5, 12,
                                13, 14, 24, 26, 0, 27, 28, 29, 34, 0,  35, 36, 37, 38, 42, 41, 43, 44, 48, 45, 46, 49, 0,  15, 0, 16};

static const short yycheck[] = {10, 6, 8,  8, 8,  9, 4, 17, 4, 19, 16, 16, 10, 4, 10, 25, 4,  3, 10, 10, 9, 4, 10, 7, 8,  9, 6,
                                6,  6, 10, 5, -1, 6, 6, 10, 5, -1, 6,  6,  10, 4, 6,  5,  10, 4, 0,  5,  4, 0, -1, 6, -1, 6};
