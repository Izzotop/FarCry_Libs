...
enum { RCP_MUL = 0, RCP_DOT, RCP_MUX, RCP_SUM };
...
public:
    void Init(OpStruct _op0, OpStruct _op1, OpStruct _op2) {
        op[0] = _op0;
        op[1] = _op1;
        op[2] = _op2;
        numOps = 3;
    }
    void Init(OpStruct _op0, OpStruct _op1) {
        op[0] = _op0;
        op[1] = _op1;
        numOps = 2;
    }
    void Init(OpStruct _op0) {
        op[0] = _op0;
        numOps = 1;
    }
    void Validate(int stage, int portion);
...
public:
    ...
    void Init(GeneralCombinerStruct _gc) {
        num = 1;
        general[0] = _gc;
    }
