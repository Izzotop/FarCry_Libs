...
EXTERN void my_jpeg_free_small JPP((j_common_ptr cinfo, void* object, size_t sizeofobject));
...
EXTERN void my_jpeg_free_large JPP((j_common_ptr cinfo, void FAR* object, size_t sizeofobject));
...
EXTERN long my_jpeg_mem_available JPP((j_common_ptr cinfo, long min_bytes_needed, long max_bytes_needed, long already_allocated));
...
EXTERN void my_jpeg_open_backing_store JPP((j_common_ptr cinfo, backing_store_ptr info, long total_bytes_needed));
