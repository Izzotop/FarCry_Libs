...
GLOBAL void my_jpeg_create_decompress(j_decompress_ptr cinfo) {
    int i;
...
GLOBAL void my_jpeg_destroy_decompress(j_decompress_ptr cinfo) {
...
GLOBAL void my_jpeg_abort_decompress(j_decompress_ptr cinfo) {
...
GLOBAL void my_jpeg_set_marker_processor(j_decompress_ptr cinfo, int marker_code, jpeg_marker_parser_method routine) {
...
GLOBAL int my_jpeg_read_header(j_decompress_ptr cinfo, boolean require_image) {
    int retcode;
...
GLOBAL int my_jpeg_consume_input(j_decompress_ptr cinfo) {
...
GLOBAL boolean my_jpeg_input_complete(j_decompress_ptr cinfo) {
...
GLOBAL boolean my_jpeg_has_multiple_scans(j_decompress_ptr cinfo) {
...
GLOBAL boolean my_jpeg_finish_decompress(j_decompress_ptr cinfo) {
