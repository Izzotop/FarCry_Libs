...
METHODDEF void format_message(j_common_ptr cinfo, char* buffer) {
    ...
    if (isstring)
        ...
        sprintf(buffer, msgtext, err->msg_parm.i[0], err->msg_parm.i[1], err->msg_parm.i[2], err->msg_parm.i[3], err->msg_parm.i[4], err->msg_parm.i[5], err->msg_parm.i[6],
                err->msg_parm.i[7]);
}
...
GLOBAL struct jpeg_error_mgr* my_jpeg_std_error(struct jpeg_error_mgr* err) {
