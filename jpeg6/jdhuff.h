...
EXTERN void my_jpeg_make_d_derived_tbl JPP((j_decompress_ptr cinfo, JHUFF_TBL* htbl, d_derived_tbl** pdtbl));
...
EXTERN boolean my_jpeg_fill_bit_buffer JPP((bitread_working_state * state, register bit_buf_type get_buffer, register int bits_left, int nbits));
...
#define HUFF_DECODE(result, state, htbl, failaction, slowlabel)                                                                                                                    \
    {                                                                                                                                                                              \
        ...
        if (bits_left < HUFF_LOOKAHEAD) {                                                                                                                                          \
            if (!my_jpeg_fill_bit_buffer(&state, get_buffer, bits_left, 0)) {                                                                                                      \
                failaction;                                                                                                                                                        \
            }                                                                                                                                                                      \
            get_buffer = state.get_buffer;                                                                                                                                         \
            bits_left = state.bits_left;                                                                                                                                           \
...
EXTERN int my_jpeg_huff_decode JPP((bitread_working_state * state, register bit_buf_type get_buffer, register int bits_left, d_derived_tbl* htbl, int min_bits));
